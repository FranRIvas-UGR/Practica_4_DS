...
void main() {
  ...
  group('Builder margarita', () {
    ...
    test('añadir ingrediente', () {
      ...
      expect(margherita.getIngredients(), ['Mozzarella cheese', 'Fresh basil', 'Tomato sauce', 'jamon']);
    });
    ...
    test('fromJson', () {
      ...
      expect(margheritaFromJson.getName(), 'Pizza margarita');
      expect(margheritaFromJson.getDough(), 'Thin crust');
      expect(margheritaFromJson.getSauce(), 'Tomato sauce');
      expect(margheritaFromJson.getIngredients(), ['Mozzarella cheese', 'Fresh basil', 'Tomato sauce']);
    ...
    test('toJson', () {
      ...
      expect(json['ingredients'], ['Mozzarella cheese', 'Fresh basil', 'Tomato sauce', 'jamon']);
  ...
  group('builder pepperoni', () {
    ...
    test('fromJson', () {
      ...
      expect(pepperoniFromJson.getIngredients(), ['Pepperoni', 'Mozzarella cheese', 'Mushrooms', 'Onions', 'Tomato sauce']);
    ...
    test('toJson', () {
      ...
      expect(json['sauce'], 'Tomato sauce');
      expect(json['ingredients'], ['Pepperoni', 'Mozzarella cheese', 'Mushrooms', 'Onions', 'Tomato sauce', 'jamon']);
  ...
  group('builder veggie', () {
    ...
    test('fromJson', () {
      ...
      expect(veggieFromJson.getIngredients(), ['Mushrooms', 'Bell peppers', 'Onions', 'Black olives', 'Spinach', 'Tomato sauce']);
    ...
    test('toJson', () {
      ...
      expect(json['dough'], 'Thin crust');
      expect(json['sauce'], 'Tomato sauce');
      expect(json['ingredients'], ['Mushrooms', 'Bell peppers', 'Onions', 'Black olives', 'Spinach', 'Tomato sauce', 'lechuga']);
